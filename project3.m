...
% Opening the HDF-EOS2 Grid File
  FILE_NAME='C:\FY3\code\datasample\FY3C_MWRID_GBAL_L1_20171002_2319_010KM_MS.HDF';
...
% Plot the data using contourfm and axesm
  ...
  min_data=floor(min(min(indata)));
  max_data=ceil(max(max(indata)));

  f=figure('Name','AMSR_E_L3_SeaIce12km_V11_20050118_SI_12km_NH_18H_DSC','visible','on')
